...
describe('getAuthorList', () => {
    ...
    it('should format fullname as empty string if family name is absent', async () => {
      // Define the sorted authors list as we expect it to be returned by the database
      const sortedAuthors = [
          {
              first_name: 'Jane',
    ...
    it('should format lifespan without date of birth if date of birth is undefined', async () => {
      // Define the sorted authors list as we expect it to be returned by the database
      const sortedAuthors = [
          {
              first_name: 'Jane',
    ...
    it('should format lifespan without date of death if date of death is undefined', async () => {
      // Define the sorted authors list as we expect it to be returned by the database
      const sortedAuthors = [
          {
              first_name: 'Jane',
    ...
    it('should format lifespan without date of birth or date of death if both dates are undefined', async () => {
      // Define the sorted authors list as we expect it to be returned by the database
      const sortedAuthors = [
          {
              first_name: 'Jane',
